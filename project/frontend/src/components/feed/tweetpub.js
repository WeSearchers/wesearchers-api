  ...
  render() {
    ...
    return (
      <div className="container-pub">
        <div className="row">
          <div className="col-md-12 col-sm-12 col-xs-12 pub1 m-5 bg-grey mr-auto ml-auto ">
            ...
            <div className="d-flex flex-row justify-content-end mr-5">
              <p className="twitter-pub mt-2 mr-3 ml-4">
            ...
            <div className="barra d-flex flex-row ml-4 mt-3 justify-content-between align-items-baseline flex-wrap">
              <div className="icons d-flex flex-row mb-4 ">
                ...
                <div className="fa fa-retweet mr-2 ml-4" />
                <p>
                  {" "}
                  {this.props.data !== undefined && this.props.data !== null
              ...
              <div className=" d-flex flex-row ml-2 mb-4">
