...
class Pub1 extends React.Component {
  ...
  componentDidMount() {
    ...
    Request.get("api/user/profile/" + this.props.data.user_id).then(
      response => {
            ...
            <div className="background-image-profile ml-3 mt-3">
              {this.state.userData !== null ? (
                <img
                  className="circle"
                  src={
                    "data:image/jpeg;base64, " + this.state.userData.image_data
                  }
                  width={"100%"}
                  style={{}}
                />
          ...
          */}
          ...
          <div className="barra d-flex flex-row ml-4 mt-3">
            <div className="icons d-flex flex-row mb-4">
              <img
                className={
                  "mr-2 ml-3 mt-1" + (this.state.vote === 1 ? "" : " opacity")
                }
                src={uparrow}
                width="18"
                height="20"
              ...
              <p className=" mt-1">
                {this.props.data !== undefined && this.props.data !== null
                  ? this.props.data.base_score + this.state.vote
                  : "Score"}
              </p>
              <img
                className={
                  "ml-2 mt-2" + (this.state.vote === -1 ? "" : " opacity")
                }
                src={downarrow}
                width="18"
                height="20"
